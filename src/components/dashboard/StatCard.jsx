...
export default function StatCard({
  ...
  return (
    <Card className="rounded-2xl border border-gray-100 bg-white shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-lg">
      <Card.Header className="flex flex-row items-start justify-between px-6 pt-6 pb-2">
        <Card.Title className="text-xs font-semibold uppercase tracking-[0.18em] text-gray-500">
          {title}
        </Card.Title>
      ...
      <Card.Footer className="px-6 pt-0">
        <div
